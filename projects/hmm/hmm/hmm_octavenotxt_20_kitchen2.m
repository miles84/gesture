function [gesturenum1 likeli1 gesturenum2 likeli2 ges_type likelihood alpha_1] = hmm_octavenotxt_20_kitchen2(dataa,object,alpha_0)
...
gesturenum2 = 7;
elseif (class==3 && likeli2 <-130) | ( (class==3) && (likeli2<-2) && (likeli2>-3) ) 
gesturenum2 = 7;
...
%if (gesturenum2 != 7)
Obs = gesturenum2;
[ges_type, likelihood, alpha_1] = hhmm(alpha_0, Obs);
%else
%ges_type = 7;
%likelihood = 100;
%alpha_1 = alpha_0;
